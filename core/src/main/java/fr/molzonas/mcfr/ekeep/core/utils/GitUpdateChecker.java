...
public class GitUpdateChecker {
     ...
     */
    public static CompletableFuture<Result> checkLatest(String currentVersion) {
     ...
     * @return Version verification result with URL to update
     */
    public static CompletableFuture<Result> checkLatest(String currentVersion, String token) {
    ...
    private static int[] parseNums(String core) {
        String[] s = core.split("\\.");
     ...
     */
    public static void logCheckAsync(Plugin plugin) {
        logCheckAsync(plugin, "");
    }

    public static void logCheckAsync(Plugin plugin, String tokenOpt) {
